...
func TestE12Serialization(t *testing.T) {
	...
	properties.Property("[BN254] SetBytes(Bytes()) should stay constant", prop.ForAll(
		func(a *E12) bool {
			var b E12
			buf := a.Bytes()
...
func TestE12ReceiverIsOperand(t *testing.T) {
	...
	properties.Property("[BN254] Having the receiver as operand (Cyclotomic square) should output the same result", prop.ForAll(
		func(a *E12) bool {
			var b E12
	...
	properties.Property("[BN254] Having the receiver as operand (Frobenius) should output the same result", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.Frobenius(a)
			a.Frobenius(a)
	...
	properties.Property("[BN254] Having the receiver as operand (FrobeniusSquare) should output the same result", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.FrobeniusSquare(a)
			a.FrobeniusSquare(a)
...
func TestE12Ops(t *testing.T) {
	...
	properties.Property("[BN254] Torus-based Compress/decompress E12 elements in the cyclotomic subgroup", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.Conjugate(a)
			a.Inverse(a)
	...
	properties.Property("[BN254] Torus-based batch Compress/decompress E12 elements in the cyclotomic subgroup", prop.ForAll(
		func(a, e, f *E12) bool {
			var b E12
			b.Conjugate(a)
			a.Inverse(a)
	...
	properties.Property("[BN254] pi**12=id", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.Frobenius(a).
				Frobenius(&b).
	...
	properties.Property("[BN254] (pi**2)**6=id", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.FrobeniusSquare(a).
				FrobeniusSquare(&b).
	...
	properties.Property("[BN254] FrobeniusSquare of x in E12 should be equal to x^(q^2)", prop.ForAll(
		func(a *E12) bool {
			var b, c E12
			q := fp.Modulus()
			b.FrobeniusSquare(a)
