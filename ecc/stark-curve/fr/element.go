...
const (
	...
	Bits  = 252 // number of bits needed to represent a Element
	Bytes = 32  // number of bytes needed to represent a Element
)

// Field modulus q
const (
	q0 uint64 = 2190616671734353199
	q1 uint64 = 13222870243701404210
	q2 uint64 = 18446744073709551615
	q3 uint64 = 576460752303423504
)
...
const qInvNeg uint64 = 13504954208620504625

// mu = 2^288 / q needed for partial Barrett reduction
const mu uint64 = 137438953471

func init() {
	_modulus.SetString("800000000000010ffffffffffffffffb781126dcae7b2321e66a241adc64d2f", 16)
}
...
func (z *Element) SetOne() *Element {
	z[0] = 5877859471073257295
	z[1] = 14366136140576156654
	z[2] = 8
	z[3] = 576460752303422961
	return z
}
...
func (z *Element) IsOne() bool {
	return ((z[3] ^ 576460752303422961) | (z[2] ^ 8) | (z[1] ^ 14366136140576156654) | (z[0] ^ 5877859471073257295)) == 0
}
...
func (z *Element) LexicographicallyLargest() bool {
	...
	var b uint64
	_, b = bits.Sub64(_z[0], 1095308335867176600, 0)
	_, b = bits.Sub64(_z[1], 15834807158705477913, b)
	_, b = bits.Sub64(_z[2], 9223372036854775807, b)
...
const (
	inversionCorrectionFactorWord0 = 8032106463353316320
	inversionCorrectionFactorWord1 = 8700016838315475554
	inversionCorrectionFactorWord2 = 5203325187556939076
	inversionCorrectionFactorWord3 = 310638733424303945
	invIterationsN                 = 18
)
