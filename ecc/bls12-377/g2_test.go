...
func TestG2AffineIsOnCurve(t *testing.T) {
	...
	properties.Property("[BLS12-377] g2Gen (affine) should be on the curve", prop.ForAll(
		func(a fptower.E2) bool {
	...
	properties.Property("[BLS12-377] g2Gen (Jacobian) should be on the curve", prop.ForAll(
		func(a fptower.E2) bool {
...
func TestG2AffineOps(t *testing.T) {
	...
	properties.Property("[BLS12-377] [-s]G = -[s]G", prop.ForAll(
		func(s fr.Element) bool {
			g := g2GenAff
			var gj G2Jac
			var nbs, bs big.Int
